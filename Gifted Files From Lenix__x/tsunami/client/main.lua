...
-- Emergency Alert
RegisterNetEvent('tsunami:client:SendEmergencyEmail', function(text)
...
-- Announcement Email
RegisterNetEvent('tsunami:client:SendAnnouncementEmail', function(text)
    Wait(math.random(7000, 13000))
    if Config.Phone == 'qb' then
        TriggerServerEvent('qb-phone:server:sendNewMail', {
        sender = "City of Los Santos",
...
RegisterNetEvent('tsunami:client:TsunamiManual', function(text)
    ...
    Wait(math.random(5000, 15000))
    TriggerEvent('tsunami:raisewater')
    Wait(math.random(5000, 15000))
...
-- Tsunami Showcase 
RegisterNetEvent('tsunami:client:TsunamiShowcase', function(text)
...
-- 30 Minutes Reminder
RegisterNetEvent('tsunami:client:SendMailTsunamiAuto30', function(text)
    Wait(math.random(5000, 15000))
...
-- 15 Minutes Reminder
RegisterNetEvent('tsunami:client:SendMailTsunamiAuto15', function(text)
    Wait(math.random(5000, 15000))
...
-- 5 Minutes Reminder
RegisterNetEvent('tsunami:client:SendMailTsunamiAuto5', function(text)
...
-- 1 Minutes Reminder
RegisterNetEvent('tsunami:client:SendMailTsunamiAuto1', function(text)
...
RegisterNetEvent('tsunami:raisewater', function()
