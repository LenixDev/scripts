...
Config.Stores = {
    ...
    [2] = {shopType = 'clothing', coords = vector3(-709.43, -153.88, 37.42), width = 2, length = 2},
    [3] = {shopType = 'clothing', coords = vector3(-1192.64, -767.66, 17.32), width = 2, length = 2},
    [4] = {shopType = 'clothing', coords = vector3(425.236, -806.008, 28.491), width = 2, length = 2},
    [5] = {shopType = 'clothing', coords = vector3(-163.19, -302.3, 39.73), width = 2, length = 2},
    ...
    [8] = {shopType = 'clothing', coords = vector3(-1450.96, -238.08, 49.81), width = 2, length = 2},
    ...
    [12] = {shopType = 'clothing', coords = vector3(-3170.92, 1042.99, 20.86), width = 2, length = 2},
    ...
    [14] = {shopType = 'clothing', coords = vector3(125.34, -224.73, 54.56), width = 2, length = 2},
    [15] = {shopType = 'barber', coords = vector3(-821.91, -184.8, 37.57), width = 2, length = 2},
    [16] = {shopType = 'barber', coords = vector3(134.03, -1709.32, 29.29), width = 2, length = 2},
    [17] = {shopType = 'barber', coords = vector3(-1285.61, -1115.25, 6.99), width = 2, length = 2},
    [18] = {shopType = 'barber', coords = vector3(1931.86, 3727.11, 32.84), width = 2, length = 2},
    [19] = {shopType = 'barber', coords = vector3(1210.29, -471.32, 66.21), width = 2, length = 2},
    [20] = {shopType = 'barber', coords = vector3(-31.22, -150.21, 57.08), width = 2, length = 2},
    [21] = {shopType = 'barber', coords = vector3(-279.47, 6230.93, 31.7), width = 2, length = 2},
    [22] = {shopType = 'clothing', coords = vector3(4496.06, -4453.6, 4.37), width = 2, length = 2},
    [23] = {shopType = 'clothing', coords = vector3(1951.48, 3765.57, 32.6), width = 2, length = 2},
}
...
Config.ClothingRooms = {
    [1] = {requiredJob = 'police', isGang = false, coords = vector3(461.95, -1000.23, 30.69), width = 6, length = 1, cameraLocation = vector4(461.02, -998.91, 31.15, 267.8)},
    ...
    [3] = {requiredJob = 'police', isGang = false, coords = vector3(461.95, -995.63, 30.69), width = 4.4, length = 1, cameraLocation = vector4(460.55, -996.68, 30.91, 266.22)},
    [4] = {requiredJob = 'mafia', isGang = true, coords = vector3(-77.55, 1009.31, 234.56), width = 2, length = 1, cameraLocation = vector4(-75.44, 1007.3, 235.25, 39.0)},
    [5] = {requiredJob = 'sheriff', isGang = false, coords = vector3(454.43, -988.85, 30.69), width = 2, length = 2, cameraLocation = vector4(454.42, -990.52, 30.69, 358.48)},
        ...
        [4] = {
            ...
            [5] = {
                ...
                outfitData = {
                    ...
                    ['vest'] = {item = 16, texture = 0, defaultItem = 0, defaultTexture = 0}, -- Body Vest
            ...
            [2] = {
                ...
                [4] = {
                    ...
                    outfitData = {
                        ...
                        ['hat'] = {item = 0, texture = 0, defaultItem = 0, defaultTexture = 0}, -- Hat
                        ['glass'] = {item = 0, texture = 0, defaultItem = 0, defaultTexture = 0}, -- Glasses
                        ['mask'] = {item = 0, texture = 1, defaultItem = 0, defaultTexture = 0} -- Mask
                    }
                }
            },
			-- Gender
        ...
        ['male'] = {
            ...
            [0] = {
                ...
                [1] = {
                    ...
                    ["accessory"]   = { item = 0, texture = 0, defaultItem = 0, defaultTexture = 0},  -- Neck Accessory
                    ["bag"]         = { item = 0, texture = 0, defaultItem = 0, defaultTexture = 0},  -- Bag
                    ["hat"]         = { item = 12, texture = 0, defaultItem = 0, defaultTexture = 0},  -- Hat
                    ["glass"]       = { item = 0, texture = 0, defaultItem = 0, defaultTexture = 0},  -- Glasses
                    ["mask"]        = { item = 0, texture = 0, defaultItem = 0, defaultTexture = 0},  -- Mask
                    }
                }
