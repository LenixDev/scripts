--[[
    ...
    yrnm studio 2024™
    Discord: yrnm.
    Discord (FiveM Alchemy): https://discord.gg/2VVw743gdj

    if i gonna update this, i gonna upload a free release on FiveM Alchemy, peace✌️

    i'm actually making a lot of stuff from np 4.0, highest quality, very close to NP 4.0 (not 1:1 but very close), in good prices, soon on sale at FiveM Alchemy✌️

    don't buy shit from AC, and other sellers, trust me bro🙌
    they only trynna make money, on raped scripts.
