            ...
            if (status.IsOnline) {
                if (status.CanCall) {
                    if (!status.InCall) {
                        ...
                        QB.Phone.Notifications.Add("fas fa-phone", "Phone", " ! أنت بالفعل في مكالمة");
                    }
                } else {
                    QB.Phone.Notifications.Add("fas fa-phone", "Phone", " ! هذا الشخص مشغول");
                }
            } else {
                QB.Phone.Notifications.Add("fas fa-phone", "Phone", " ! هذا الشخص غير متوفر");
            }
        } else {
            QB.Phone.Notifications.Add("fas fa-phone", "Phone", " ! لا يمكنك الاتصال بنفسك");
        }
    });
});
...
$(document).on('click', '#new-chat-phone', function(e){
    ...
    if (ContactData.number !== QB.Phone.Data.PlayerData.charinfo.phone) {
        ...
        QB.Phone.Notifications.Add("fa fa-phone-alt", "Phone", "لا يمكنك التواصل مع نفسك", "default", 3500);
    }
});
...
$(document).on('click', '#edit-contact-save', function(e){
    ...
    if (ContactName != "" && ContactNumber != "") {
        ...
        QB.Phone.Notifications.Add("fas fa-exclamation-circle", "Edit Contact", "! املئ جميع الفراغات");
    }
});
...
$(document).on('click', '#add-contact-save', function(e){
    ...
    if (ContactName != "" && ContactNumber != "") {
        ...
        QB.Phone.Notifications.Add("fas fa-exclamation-circle", "Add Contact", "! املئ جميع الفراغات");
    }
});
        ...
        if (cData.number !== QB.Phone.Data.PlayerData.charinfo.phone) {
            if (status.IsOnline) {
                if (status.CanCall) {
                    ...
                    QB.Phone.Notifications.Add("fas fa-phone", "Phone", "! هاذا الشخص بالفعل في مكالمة");
                }
            } else {
                QB.Phone.Notifications.Add("fas fa-phone", "Phone", "! هاذا الشخص غير متوفر");
            }
        } else {
...
IncomingCallAlert = function(CallData, Canceled, AnonymousCall) {
    if (!Canceled) {
        if (!QB.Phone.Data.CallActive) {
            ...
            QB.Phone.Animations.TopSlideUp('.'+QB.Phone.Data.currentApplication+"-app", 400, -160);
            setTimeout(function(){
                var Label = CallData.name+"لديك مكالمة واردة من "
                if (AnonymousCall) {
                    Label = "يتم الاتصال بك من قبل شخص مجهول"
                }
