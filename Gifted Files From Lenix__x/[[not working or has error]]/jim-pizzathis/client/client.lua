...
RegisterNetEvent('QBCore:Client:OnPlayerLoaded', function()
    QBCore.Functions.GetPlayerData(function(PlayerData)
        ...
        if PlayerData.job.onduty then if PlayerData.job.name == "pizza" then TriggerServerEvent("QBCore:ToggleDuty") end end
    end)
end)
...
AddEventHandler('onResourceStart', function(resource) if GetCurrentResourceName() ~= resource then return end
	QBCore.Functions.GetPlayerData(function(PlayerData) PlayerJob = PlayerData.job if PlayerData.job.name == "pizza" then onDuty = PlayerJob.onduty end end)
end)

CreateThread(function()
	local bossroles = {}
	for grade in pairs(QBCore.Shared.Jobs["pizza"].grades) do
		if QBCore.Shared.Jobs["pizza"].grades[grade].isboss == true then
			if bossroles["pizza"] then
				if bossroles["pizza"] > tonumber(grade) then bossroles["pizza"] = tonumber(grade) end
			else bossroles["pizza"] = tonumber(grade) end
		end
	end
	for _, v in pairs(Config.Locations) do
		if v.zoneEnable then
			JobLocation = PolyZone:Create(v.zones, { name = v.label, debugPoly = Config.Debug })
			JobLocation:onPlayerInOut(function(isPointInside) if not isPointInside and onDuty and PlayerJob.name == "pizza" then TriggerServerEvent("QBCore:ToggleDuty") end end)

			--Blips[#Blips+1] = makeBlip({coords = v.blip, sprite = 267, col = v.blipcolor, scale = 0.7, disp = 6, name = v.label})
		end
	end
	Targets["PizzTray"] =
	exports['qb-target']:AddBoxZone("PizzTray", vector3(287.4, -979.2, 29.43), 0.6, 0.6, { name="PizzTray", heading = 0.0, debugPoly=Config.Debug, minZ = 29.43, maxZ = 29.88, },
		{ options = { {  event = "jim-pizzathis:Stash", icon = "fas fa-box-open", label = Loc[Config.Lan].targetinfo["toppings_tray"], stash = "Toppings", job = "pizza" }, }, distance = 1.0 })

	Targets["PizzBase"] =
	exports['qb-target']:AddBoxZone("PizzBase", vector3(286.41, -983.34, 29.43), 0.95, 0.45, { name="PizzBase", heading = 0.0, debugPoly=Config.Debug, minZ = 29.23, maxZ = 29.83, },
		{ options = { {  event = "jim-pizzathis:Crafting", icon = "fas fa-pizza-slice", label = Loc[Config.Lan].targetinfo["prepare_pizza"], job = "pizza", craftable = Crafting.Base, header = Loc[Config.Lan].menu["pizza_base"], coords = vector3(811.42, -754.55, 26.78) }, }, distance = 1.0 })

	Targets["PizzDough"] =
	exports['qb-target']:AddBoxZone("PizzDough", vector3(286.67, -983.01, 29.43), 1.0, 1.0, { name="PizzDough", heading = 0.0, debugPoly=Config.Debug, minZ = 28.58, maxZ = 29.18, },
		{ options = { {  event = "jim-pizzathis:JustGive", icon = "fas fa-cookie", label = Loc[Config.Lan].targetinfo["prepare_dough"], job = "pizza", id = "pizzadough", coords = vector3(806.98, -757.05, 26.78) }, }, distance = 1.0 })

	Targets["PizzOven"] =
	exports['qb-target']:AddBoxZone("PizzOven", vector3(288.56, -986.57, 29.43), 0.4, 1.25, { name="PizzOven", heading = 0.0, debugPoly=Config.Debug, minZ = 29.18, maxZ = 30.03, },
		{ options = { {  event = "jim-pizzathis:Crafting", icon = "fas fa-temperature-high", label = Loc[Config.Lan].targetinfo["use_oven"], job = "pizza", craftable = Crafting.Oven, header = Loc[Config.Lan].menu["oven_menu"], coords = vector3(808.28, -761.19, 26.78) }, }, distance = 1.0 })

	Targets["PizzChop"] =
	exports['qb-target']:AddBoxZone("PizzChop", vector3(284.15, -983.51, 29.43), 0.6, 0.2, { name="PizzChop", heading = 0.0, debugPoly=Config.Debug, minZ = 29.18, maxZ = 29.58, },
		{ options = { {  event = "jim-pizzathis:Crafting", icon = "fas fa-utensils", label = Loc[Config.Lan].targetinfo["chopping_board"], job = "pizza", craftable = Crafting.ChoppingBoard, header = Loc[Config.Lan].menu["chopping_board"], coords = vector3(810.45, -765.17, 26.78) }, }, distance = 1.0	})
	...
	-- 	{ options = { { event = "jim-pizzathis:Crafting", icon = "fas fa-utensils", label = Loc[Config.Lan].targetinfo["chopping_board"], job = "pizza", craftable = Crafting.ChoppingBoard, header = Loc[Config.Lan].menu["chopping_board"], coords = vector3(809.26, -761.19, 26.78) }, }, distance = 1.0	})

	Targets["PizzBurner"] =
	exports['qb-target']:AddBoxZone("PizzBurner", vector3(287.94, -980.92, 29.43), 0.4, 2.1, { name="PizzBurner", heading = 0.0, debugPoly=Config.Debug, minZ = 28.23, maxZ = 30.13, },
		{ options = { { event = "jim-pizzathis:Crafting", icon = "fas fa-temperature-high", label = Loc[Config.Lan].targetinfo["stone_oven"],"Use Stone Oven", job = "pizza", craftable = Crafting.PizzaOven, header = Loc[Config.Lan].menu["stone_pizza"], coords = vector3(814.05, -752.89, 26.78) }, }, distance = 1.0 })

	Targets["PizzWine"] =
	exports['qb-target']:AddBoxZone("PizzWine", vector3(289.96, -979.18, 29.43), 0.4, 0.9, { name="PizzWine", heading = 0.0, debugPoly=Config.Debug, minZ = 30.03, maxZ = 30.58, },
		{ options = { {  event = "jim-pizzathis:Shop", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["wine_rack"], job = "pizza", shop = Config.WineItems, coords = vector3(809.34, -761.84, 22.3) }, }, distance = 1.5 })
	Targets["VaniWine"] =
	exports['qb-target']:AddBoxZone("VaniWine", vector3(129.93, -1279.9, 29.27), 1.4, 0.4, { name="VaniWine", heading = 30.0, debugPoly=Config.Debug, minZ = 29.17, maxZ = 29.87, },
	 	{ options = { {  event = "jim-pizzathis:Shop", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["wine_rack"], job = "vanilla", shop = Config.WineItems, coords = vector3(807.25, -761.79, 22.3) }, }, distance = 1.5 })

	Targets["PizzFridge"] =
	exports['qb-target']:AddBoxZone("PizzFridge", vector3(288.13, -979.37, 29.43), 1.0, 5.2, { name="PizzFridge", heading = 0.0, debugPoly=Config.Debug, minZ = 28.23, maxZ = 29.43, },
		{ options = { {  event = "jim-pizzathis:Shop", icon = "fas fa-temperature-low", label = Loc[Config.Lan].targetinfo["food_fridge"],  job = "pizza", shop = Config.FoodItems, coords = vector3(805.68, -761.62, 26.78) }, }, distance = 2.0 })
	Targets["PizzFridge2"] =
	exports['qb-target']:AddBoxZone("PizzFridge2", vector3(286.25, -979.14, 29.43), 0.4, 0.75, { name="PizzFridge2", heading = 0.0, debugPoly=Config.Debug, minZ=29.38, maxZ=30.08 },
		{ options = { {  event = "jim-pizzathis:Shop", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["drink_fridge"], job = "pizza", shop = Config.DrinkItems, coords = vector3(814.07, -748.64, 26.78) }, }, distance = 1.5 })
	Targets["PizzFridge3"] =
	exports['qb-target']:AddBoxZone("PizzFridge3", vector3(281.99, -986.15, 29.43), 1.55, 0.6, { name="PizzFridge3", heading = 0.0, debugPoly=Config.Debug, minZ = 28.23, maxZ = 30.48, },
		{ options = { {  event = "jim-pizzathis:Shop", icon = "fas fa-temperature-low", label = Loc[Config.Lan].targetinfo["food_fridge"],  job = "pizza", shop = Config.FoodItems, coords = vector3(805.68, -761.62, 26.78) }, }, distance = 2.0 })
	Targets["PizzFreezer"] =
	exports['qb-target']:AddBoxZone("PizzFreezer", vector3(292.23, -986.37, 29.43), 1.15, 1.2, { name="PizzFreezer", heading = 0.0, debugPoly=Config.Debug, minZ = 28.23, maxZ = 29.42, },
		{ options = { {  event = "jim-pizzathis:Shop", icon = "fas fa-temperature-low", label = Loc[Config.Lan].targetinfo["open_freezer"], job = "pizza", shop = Config.FreezerItems, coords = vector3(802.75, -756.85, 26.78) }, }, distance = 1.0 })

	Targets["PizzWash1"] =
	exports['qb-target']:AddBoxZone("PizzWash1", vector3(289.4, -977.43, 29.43), 0.3, 0.5, { name="PizzWash1", heading = 0.0, debugPoly=Config.Debug, minZ = 29.08, maxZ = 29.48, },
	...
	Targets["PizzWash2"] =
	exports['qb-target']:AddBoxZone("PizzWash2", vector3(288.1, -977.42, 29.43), 0.3, 0.5, { name="PizzWash2", heading = 0.0, debugPoly=Config.Debug, minZ = 29.08, maxZ = 29.48, },
	...
	Targets["PizzWash3"] =
	exports['qb-target']:AddBoxZone("PizzWash3", vector3(281.99, -981.37, 29.43), 0.9, 0.6, { name="PizzWash3", heading = 0.0, debugPoly=Config.Debug, minZ = 29.03, maxZ = 29.88, },
	...
	-- 	{ options = { { event = "jim-pizzathis:washHands", icon = "fas fa-hand-holding-water", label = Loc[Config.Lan].targetinfo["wash_hands"], job = "pizza", coords = vector3(800.88, -767.88, 26.78) }, }, distance = 1.5 })
	-- Targets["PizzWash5"] =
	...
	Targets["PizzCounter"] =
	exports['qb-target']:AddBoxZone("PizzCounter", vector3(290.1, -977.03, 29.43), 0.6, 0.6, { name="PizzCounter", heading = 349.0, debugPoly=Config.Debug, minZ = 29.43, maxZ = 29.98, },
	...
	exports['qb-target']:AddBoxZone("PizzCounter2", vector3(286.68, -977.03, 29.43), 0.6, 0.6, { name="PizzCounter2", heading = 0.0, debugPoly=Config.Debug, minZ = 29.43, maxZ = 29.98, },
	...
	Targets["PizzReceipt"] =
	exports['qb-target']:AddBoxZone("PizzReceipt", vector3(290.74, -977.01, 29.43), 0.6, 0.6, { name="PizzReceipt", heading = 0.0, debugPoly=Config.Debug, minZ = 29.43, maxZ = 30.03, },
		{ options = { { event = "jim-payments:client:Charge", icon = "fas fa-credit-card", label = Loc[Config.Lan].targetinfo["charge_customer"], job = "pizza", coords = vector3(811.32, -750.77, 26.78),
						img = "<center><p><img src=https://static.wikia.nocookie.net/gtawiki/images/5/59/PizzaThis.png width=200px></p>",
		} }, distance = 2.0 })
	Targets["PizzReceipt2"] =
	exports['qb-target']:AddBoxZone("PizzReceipt2", vector3(287.35, -977.0, 29.43), 0.6, 0.6, { name="PizzReceipt2", heading = 0.0, debugPoly=Config.Debug, minZ = 29.43, maxZ = 30.03, },
		{ options = { { event = "jim-payments:client:Charge", icon = "fas fa-credit-card", label = Loc[Config.Lan].targetinfo["charge_customer"], job = "pizza", coords = vector3(811.29, -752.09, 26.78),
						img = "<center><p><img src=https://static.wikia.nocookie.net/gtawiki/images/5/59/PizzaThis.png width=200px></p>",
		} }, distance = 2.0	})

	Targets["PizzTap"] =
	exports['qb-target']:AddBoxZone("PizzTap", vector3(289.44, -977.14, 29.43), 0.25, 0.7, { name="PizzTap", heading = 0.0, debugPoly=Config.Debug, minZ = 29.43, maxZ = 30.03, },
		{ options = { { event = "jim-pizzathis:Crafting", icon = "fas fa-beer", label = Loc[Config.Lan].targetinfo["pour_beer"], job = "pizza", craftable = Crafting.Beer, header = Loc[Config.Lan].menu["beer_menu"], coords = vector3(814.14, -749.35, 26.78) }, }, distance = 1.5 })
	Targets["PizzTap2"] =
	exports['qb-target']:AddBoxZone("PizzTap2", vector3(288.11, -977.13, 29.43), 0.25, 0.7, { name="PizzTap2", heading = 0.0, debugPoly=Config.Debug, minZ = 29.43, maxZ = 30.03, },
		{ options = { { event = "jim-pizzathis:Crafting", icon = "fas fa-beer", label = Loc[Config.Lan].targetinfo["pour_beer"], job = "pizza", craftable = Crafting.Beer, header = Loc[Config.Lan].menu["beer_menu"], coords = vector3(814.14, -749.35, 26.78) }, }, distance = 1.5 })
	...
	-- 	{ options = { { event = "jim-pizzathis:JustGive", icon = "fas fa-mug-hot", label = Loc[Config.Lan].targetinfo["pour_coffee"], job = "pizza", id = "coffee", coords = vector3(808.78, -765.35, 26.78)}, }, distance = 2.0 })
	-- Targets["PizzCoffee2"] =
	...
	-- 	{ options = { { event = "jim-pizzathis:JustGive", icon = "fas fa-mug-hot", label = Loc[Config.Lan].targetinfo["pour_coffee"], job = "pizza", id = "coffee", coords = vector3(811.49, -764.82, 26.78)}, }, distance = 2.0 })

	Targets["PizzClockin"] =
	exports['qb-target']:AddBoxZone("PizzClockin", vector3(281.65, -980.73, 29.43), 0.4, 0.4, { name="PizzClockin", heading = 0.0, debugPoly=Config.Debug, minZ = 29.83, maxZ = 30.28, },
		{ options = { { type = "server", event = "QBCore:ToggleDuty", icon = "fas fa-user-check", label = Loc[Config.Lan].targetinfo["toggle_duty"], job = "pizza", coords = vector3(807.15, -761.83, 31.27) }, }, distance = 2.0 })
	...
	-- 	{ options = { { type = "server", event = "QBCore:ToggleDuty", icon = "fas fa-user-check", label = Loc[Config.Lan].targetinfo["toggle_duty"], job = "pizza", coords = vector3(804.44, -760.52, 31.27) }, }, distance = 2.0 })

	Targets["PizzBoss"] =
	exports['qb-target']:AddBoxZone("PizzBoss", vector3(288.14, -990.09, 29.43), 1.2, 0.3, { name="PizzBoss", heading = 0.0, debugPoly=Config.Debug, minZ = 29.18, maxZ = 29.88, },
