...
Config.Garages = {
    ...
    police = {
        label = 'Police',
        takeVehicle = vector3(-1118.44, -859.93, 12.84),
        zone = {
            shape = {
                vector2(-1125.7045898438, -869.25463867188),
                vector2(-1108.0701904297, -856.26422119141),
                vector2(-1112.8609619141, -850.69287109375),
                vector2(-1129.5373535156, -864.01782226563)
            },
            minZ = 12.31,
            maxZ = 16.31,
        },
        spawnPoint = {
            vector4(-1112.1, -855.84, 12.83, 221.02),
            vector4(-1115.2, -858.06, 12.83, 217.64),
            vector4(-1123.03, -863.33, 12.87, 218.89),
            vector4(-1125.84, -865.5, 12.85, 220.76),
        },
        showBlip = false,
        blipName = 'Police',
        blipNumber = 357,
