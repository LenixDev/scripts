        ...
        QBCore.Functions.TriggerCallback('qb-banktrucks:server:hasItem', function(item)
            if item then
                ...
                QBCore.Functions.Progressbar("search_body", "Accessing", 5000, false, true, {
                    ...
                    function() -- Success
                        TriggerServerEvent("QBCore:Server:RemoveItem", "radioscanner", 1)
                        TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["radioscanner"], "remove")
...
RegisterNetEvent('qb-banktrucks:client:gettruck', function ()
    ...
    if BodySearched then
        ...
        TriggerServerEvent("QBCore:Server:RemoveItem", "pinger", "1")
        TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["pinger"], "remove")
    end
end)
...
function AccessDoors()
    ...
    QBCore.Functions.Progressbar("search_body", "Setting Timer", 5000, false, true, {
        ...
        function() -- Success
            TriggerServerEvent("QBCore:Server:RemoveItem", "tablet", 1)
            TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["tablet"], "remove")
            ClearPedTasks(ped)
            DetachEntity(prop)
