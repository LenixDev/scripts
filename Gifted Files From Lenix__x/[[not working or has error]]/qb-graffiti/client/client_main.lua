...
CreateThread(function()
    ...
    local blip = AddBlipForCoord(vector3(-1642.83, -1047.06, 12.31))
    ...
    local npc = CreatePed(4, GetHashKey('a_m_m_rurmeth_01'), vector3(-1642.83, -1047.06, 12.31), 347.5, false, false)
...
RegisterNetEvent('qb-graffiti:client:removeClosestGraffiti', function(slot)
    ...
    if isLoaded then
        if not graffiti then
            ...
            TriggerServerEvent('qb-graffiti:server:removeServerItem', 'spray_remover', 1, slot)
