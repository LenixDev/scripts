...
RegisterServerEvent("fakeid:server:ForgeIDCard", function(citizenid, firstname, lastname, birthday, nationality)
    local src = source
...
RegisterServerEvent("fakeid:server:ForgeDrivers", function(firstname,lastname,birthday)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent("fakeid:server:ForgeWeapon", function(firstname,lastname,birthday)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent("fakeid:server:ForgeLawyerpass", function(passid,firstname,lastname, citizenid)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
