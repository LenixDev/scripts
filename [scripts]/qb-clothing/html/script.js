...
QBClothing.ReloadOutfits = function(outfits) {
    ...
    $.each(outfits, function(index, outfit) {
        var elem = '<div class="clothing-menu-option" data-myOutfit="' + (index + 1) + '"> <div class="clothing-menu-option-header"><p>' + outfit.outfitname + '</p></div><div class="clothing-menu-myOutfit-option-button"><p data-tkey="select">Select</p></div><div class="clothing-menu-myOutfit-option-button-remove"><p data-tkey="delete">حذف</p></div></div>'
    ...
    $.each(data.menus, function(i, menu) {
        ...
        if (menu.menu == "roomOutfits") {
            $.each(menu.outfits, function(index, outfit) {
                var elem = '<div class="clothing-menu-option" data-outfit="' + (index + 1) + '"> <div class="clothing-menu-option-header"><p>' + outfit.outfitLabel + '</p></div> <div class="clothing-menu-outfit-option-button"><p data-tkey="select">اخذ الملابس</p></div> </div>'
        ...
        if (menu.menu == "myOutfits") {
            $.each(menu.outfits, function(index, outfit) {
                var elem = '<div class="clothing-menu-option" data-myOutfit="' + (index + 1) + '"> <div class="clothing-menu-option-header"><p>' + outfit.outfitname + '</p></div><div class="clothing-menu-myOutfit-option-button"><p data-tkey="select">اختيار</p></div><div class="clothing-menu-myOutfit-option-button-remove"><p data-tkey="delete">حذف</p></div></div>'
                $(".clothing-menu-myOutfits-container").append(elem)
