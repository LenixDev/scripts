...
RegisterNetEvent('banking:client:fetchAccounts', function(accounts)
...
RegisterNetEvent("banking:client:fetchAccount", function(account)
    SendData({
...
RegisterNetEvent('advanced_banking:client:account:action', function(account_id, action, amount, reason)
    ...
    TriggerEvent("banking:client:notification", description, "info")
end)
