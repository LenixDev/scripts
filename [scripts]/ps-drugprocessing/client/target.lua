...
Citizen.CreateThread(function()
    local blipsToCreate = {
        ...
        {coords = vector3(-1187.17, -446.24, 43.91)},
        {coords = vector3(813.21, -2398.69, 23.66)},
        {coords = vector3(102.07, 175.09, 104.59)},
        {coords = vector3(3536.71, 3662.63, 28.12)},
    }

    for _, blipInfo in ipairs(blipsToCreate) do
        local blip = AddBlipForCoord(blipInfo.coords.x, blipInfo.coords.y, blipInfo.coords.z) -- Create blip at specified coordinates
