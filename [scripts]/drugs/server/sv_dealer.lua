...
lib.callback.register('drugs:server:getDealers', function()
    local temp = {}
...
lib.callback.register('drugs:server:getDealerPosition', function(_, dealerID)
...
lib.callback.register('drugs:server:getDealerSellItems', function(_, dealerID)
    if not dealers[dealerID] then
        return
    end
...
lib.callback.register('drugs:server:getDealerBuyItems', function(_, dealerID)
    if not dealers[dealerID] then
        return
    end
...
RegisterNetEvent('drugs:server:sellItemsToDealer', function (dealerID, item, amount, total)
    ...
    TriggerClientEvent('drugs:client:syncRestLoop', source, false)
end)

RegisterNetEvent('drugs:server:buyItemsFromDealer', function(dealerID, item, amount, total)
    local src = source
