...
lib.callback.register('drugs:server:getPlantById', function(source, plantId)
...
---@return Plant | nil: the plant object
lib.callback.register('drugs:server:getPlantByNetId', function(source, netId)
...
lib.callback.register('drugs:server:getPlantByOwner', function(source)
...
---@param source number: the source player
---@return table | nil: the list of plants
lib.callback.register('drugs:server:getPlants', function(source)
...
local setupPlants = function()
    ...
    TriggerClientEvent('drugs:client:syncPlantList', -1, plants)
    return true
end
...
AddEventHandler('onResourceStart', function(resource)
    ...
    TriggerClientEvent('drugs:client:syncPlantList', -1)
...
RegisterNetEvent('drugs:server:createNewPlant', function(coords, plantItem, zone, metadata)
    local src = source
...
RegisterNetEvent('drugs:server:plantTakeCare', function(plantId, item)
...
---@param plantId string: the plant Id
RegisterNetEvent('drugs:server:harvestPlant', function(plantId)
...
RegisterNetEvent('drugs:server:destroyPlant', function(args)
    ...
    if DoesEntityExist(plant.entity) then
        ...
        TriggerClientEvent('drugs:client:startPlantFire', -1, plant.coords)
