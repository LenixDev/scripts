...
lib.callback.register('drugs:server:getRecipeById', function(source, tableId, recipeId)
...
lib.callback.register('drugs:server:getTableRecipes', function(source, id)
...
lib.callback.register('drugs:server:getTableById', function(source, id)
...
lib.callback.register('drugs:server:getTableByNetId', function(source, netId)
...
lib.callback.register('drugs:server:getTableByOwner', function(source)
...
lib.callback.register('drugs:server:getTables', function(source)
    local temp = {}
...
local setupTables = function()
    ...
    TriggerClientEvent('drugs:client:syncTables', -1, processingTables)
    return true
end
...
RegisterNetEvent('drugs:server:processDrugs', function(data)
...
RegisterNetEvent('drugs:server:removeTable', function(args)
...
RegisterNetEvent('drugs:server:createNewTable', function(coords, type, rotation, metadata)
    local src = source
...
RegisterNetEvent('drugs:server:syncparticlefx', function(status, tableId, netId, particlefx)
    TriggerClientEvent('drugs:client:syncparticlefx',-1, status, tableId, netId, particlefx)
end)
