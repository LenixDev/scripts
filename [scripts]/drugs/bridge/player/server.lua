...
function it.getMoney(source, moneyType)
    ...
    lib.print.error('['..it.name..' | getMoney] More information about this error: https://help.scripts.com/errors')
    return 0
end
...
-- OX Callbacks
lib.callback.register('lib:getPlayerName', function(source)
    return it.getPlayerName(source)
end)

lib.callback.register('lib:getCitizenId', function(source)
    return it.getCitizenId(source)
end)

lib.callback.register('lib:getLicences', function(source)
    return it.getLicences(source)
end)

lib.callback.register('lib:getLicence', function(source, licenseType)
