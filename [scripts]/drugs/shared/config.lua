...
Config.Zones = {
    ['weed_zone_one'] = { -- Zone id (Musst be unique)
        points = {
            vector3(1115.88, -1233.91, 16.42),
            vector3(1112.34, -1236.86, 16.42),
            vector3(1115.34, -1240.75, 16.42),
            vector3(1119.18, -1238.81, 16.42),
        },
        thickness = 4.0,
        ...
        blip = {
            ...
            sprite = 310, -- Select blip from (https://docs.fivem.net/docs/game-references/blips/)
            displayColor = 1, -- Select blip color from (https://docs.fivem.net/docs/game-references/blips/)
            displayText = 'Anonymous',
        },
    },
    ['weed_zone_two'] = { -- Zone id (Musst be unique)
        points = {
            vector3(2007.72, 4982.06, 36.84),
            vector3(2015.44, 4973.78, 36.84),
            vector3(2023.54, 4981.88, 36.84),
            vector3(2019.98, 4987.5, 36.84),
            vector3(2024.54, 4992.17, 36.84),
            vector3(2022.52, 4993.63, 36.84),
        },
        thickness = 4.0,
        growMultiplier = 2, -- GlobalGrowTime / growMultiplier = Time in minutes for a plant to grow in this zone
        blip = {
...
Config.ProcessingSkillCheck = true -- Enable skill check for processingTables (Replaces the progressbar)
Config.SkillCheck = {
        ...
        recipes = {
            ['joint Og'] = {
                ...
                ingrediants = {
                    ...
                    ['rolling_paper'] = {amount = 1, remove = true}
                },
                outputs = {
                    ['joint'] = 2
                },
