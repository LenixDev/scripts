RegisterNetEvent('drugs:client:showAdminAlertBox', function(args)
    ...
    if alert == 'confirm' then
        ...
        lib.setClipboard('add_ace identifier.'..userLicense..' drugs allow #'..username..' License')
        ShowNotification(nil, _U('NOTIFICATION__COPY__CLIPBOARD'):format('User License'), "success")
    end
end)

RegisterNetEvent('drugs:client:addAllAdminBlips', function(args)
...
RegisterNetEvent('drugs:client:addAdminBlip', function(args)
    local id = args.id
...
RegisterNetEvent('drugs:client:removeAllAdminBlips', function(args)
    local type = args.type
...
RegisterNetEvent('drugs:client:generatePlantListMenu', function()
    ...
    TriggerEvent('drugs:client:showPlantListMenu', {plantList = plantList})
end)

RegisterNetEvent('drugs:client:generateTableListMenu', function()
    local currentCoords = GetEntityCoords(PlayerPedId())
    local allTables = lib.callback.await('drugs:server:getTables', false)
    ...
    TriggerEvent('drugs:client:showTableListMenu', {tableList = tableList})
end)

RegisterNetEvent('drugs:client:showGroundHash', function()
