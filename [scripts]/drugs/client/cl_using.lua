...
RegisterNetEvent('drugs:client:takeDrug', function(drugItem)
...
lib.callback.register('drugs:client:isDrugOnCooldown', function(drugItem)
...
lib.callback.register('drugs:client:getCurrentDrugEffect', function()
    return currentDrug
end)